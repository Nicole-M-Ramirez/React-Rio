...
function Contrasena({route}) {
  ...
  return (
    <View>
      ...
      <BodyView>
        {/* {title} */}
        { pantalla === 'NewPassword' ? <Text style={styles.titleText}>Porfavor registre su contraseña anterior</Text> : <Image source={require('../assets/miPerfil2.png')} resizeMode='contain' style={styles.titleImage} /> }
