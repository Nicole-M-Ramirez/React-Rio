...
function HeaderInicio(props) {
  const navigation = useNavigation();

  return (
    <View >
      <TouchableOpacity onPress={()=>{}} style={{width:dimensions.bodyWidth*0.09,left: dimensions.leftMargin, top: dimensions.headerHeight *0.7}}>
        <Image source={require('../assets/hogar2.png')} resizeMode='contain' style={[styles.buttonImage]} />
      </TouchableOpacity>

      <TouchableOpacity onPress={()=>{}} style={{position:'absolute', width:dimensions.bodyWidth*0.09, top: dimensions.bodyHeight*0.075, right:dimensions.leftMargin-4}}>
