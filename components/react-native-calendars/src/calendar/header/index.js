...
const CalendarHeader = forwardRef((props, ref) => {
    ...
    //
    // RIO: Aqui distinguir entra la flecha derecha y la izquierda
    //
    const _renderArrow = (direction) => {
        ...
        const imageSource = isLeft ? 
            require('../../../../../assets/back.png') : require('../../../../../assets/continuar.png');
        const renderArrowDirection = isLeft ? 'left' : 'right';
        const arrowStyleRafa = isLeft ? { left:-10}: {position: 'absolute', left: dimensions.bodyWidth - 40} ;
    ...
    >
      ...
      {/* <View style={{top:dimensions.bodyHeight + 9 * dimensions.separator, backgroundColor: 'red'}}>   */}
        {_renderArrow('left')}
