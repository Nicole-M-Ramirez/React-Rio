  ...
  return (
    <ImageBackground source={require('../../assets/test3.gif')} resizeMode="cover" style={styles.imageBackground} >
      ...
      <FooterView> 
        ...
        <TouchableOpacity  style={{left:dimensions.bodyWidth*0.7,width:dimensions.bodyWidth*0.25,height:dimensions.footerHeight*0.5,marginTop: dimensions.separator*5}}  onPress={() => navigation.navigate('RegistroUtilidad',{pantalla:pantalla,img:<Image source={require('../../assets/meditacion2.png')} resizeMode='contain' style={[styles.buttonImage,{top:0,width: dimensions.bodyWidth *0.5, height:dimensions.bodyHeight*0.34}]} />, forDate: forDate,nombre: "Meditacion", actividad: gs['meditacion'][lang] })}>
