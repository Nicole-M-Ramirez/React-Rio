...
import { updateContactDelete } from '../../redux/slices/counterSlice';
...
function BorrarContacto() {
    ...
    function borrar () {
        ...
        dispatch(updateContactDelete({"cont":'000'}));
  ...
  return (
    <View>
      ...
      <BodyView>
        <Text style={styles.textEx}>{gs['confirmarBorrarCont'][lang]}</Text>
            ...
            <View>
                ...
                <TouchableOpacity style={[styles.buttonView,{backgroundColor:colors.mintGreen,}]} onPress={() => navigation.navigate('ContactoPersona')}>
